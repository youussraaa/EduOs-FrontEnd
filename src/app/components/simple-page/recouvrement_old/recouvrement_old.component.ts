...
@Component({
  selector: "app-recouvrement_old",
  templateUrl: "./recouvrement_old.component.html",
  styleUrl: "./recouvrement_old.component.scss",
})
export class Recouvrement_oldComponent {
